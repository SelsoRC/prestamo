...
//se declara la variable alert pa utilizarla despues 
    ...
    if (empty($_POST['descripcion']) || empty($_POST['cantidad']) || empty($_POST['marca']) || empty($_POST['modelo']) || empty($_POST['serie']) || empty($_POST['observaciones']) || empty($_POST['categoria'])  || empty($_POST['area'])  || $_POST['cantidad'] <= 0) {
    ...
    // hacer una consulta que se guarda en la variable query checa si no se repiten los siguientyes datos en la db
            ...
            $query_insert = mysqli_query($conexion,"INSERT INTO equipo(area,descripcion,cantidad,marca,modelo,numeroserie,observaciones,categoria,foto)
                                            VALUES ($area,'$descripcion',$cantidad,'$marca','$modelo','$numeroserie','$observaciones',$categoria,'$imgProducto')");
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Registro Equipo</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center">Registro equipo</h3>
                                        </div>
                                        <hr>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="marca" name="marca" type="text" class="form-control cc-exp" value="" data-val="true" data-val-required="Please enter the card expiration" data-val-cc-exp="Please enter a valid month and year" placeholder="Marca" required/>
                                                        <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="modelo" name="modelo" type="text" class="form-control cc-exp" value="" data-val="true" data-val-required="Please enter the card expiration" data-val-cc-exp="Please enter a valid month and year" placeholder="Modelo" required/>
                                                        <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="serie" name="serie" type="text" class="form-control cc-exp" value="" data-val="true" data-val-required="Please enter the card expiration" data-val-cc-exp="Please enter a valid month and year" placeholder="serie" required/>
                                                        <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                    </div>
                                                </div>
                     ...
                     ?>
                                            ...
                                            <div>
                                                <button id="payment-button" type="submit" class="btn btn-lg btn-info btn-block">
                                                    <span id="payment-button-amount">Guardar Equipo</span>
