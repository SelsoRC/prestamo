            ...
            <div class="animated fadeIn">
               ...
               <!--  INCIA LA TABLA ------------------------------------------------------------------------------- -->
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div>
                                ...
                                <a href="pdf2/reporte_historial.php" style="color: white;" target="_blank" ><i class="fa fa-print" style="color: white;"></i> Generar reporte</a>   
                                </button>
                            ...
                            <div class="card-body">
                                ...
                                <table id="tabla" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        if(isset($_SESSION['msj_historial'])){
                                        echo "<script>
                                                Swal.fire(
                                                '¡Eliminado!',
                                                'Registro eliminado',
                                            ...
                                            unset($_SESSION['msj_historial']);
                                                }

                $query = mysqli_query($conexion, "SELECT historial.idhistorial, equipo.descripcion, equipo.foto, estudiante.nombre, estudiante.numerocontrol, usuario.usuario,historial.fecha, historial.cantidadprestado 
                    FROM historial 
                ...
                $datos = mysqli_fetch_all($query, MYSQLI_ASSOC);
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-danger"><a  href="eliminar_historial.php? id= <?php echo $datos["idhistorial"];?>" class="devo" style="color: white;">Eliminar</a></button>
                                    </td>
                                                </tr>
                                            <?php } 
