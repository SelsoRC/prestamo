            ...
            <div class="animated fadeIn">
               ...
               <!--  INCIA LA TABLA ------------------------------------------------------------------------------- -->
                 ...
                 <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">EQUIPOS</strong>
                            </div>

                            <div>
                             <form action="pdf2/reporte_equipo.php" method="POST" target="_blank">
                    ...
                    <a href="registro_equipo.php"><button type="button" class="btn btn-success btn-sm"><i class="fa fa-plus-circle" style="color: white;"></i></button></a>
                                ...
                                <table id="tabla" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        echo "<script>
                                            ...
                                            unset($_SESSION['msj_equipo']);
                                                }

                $query = mysqli_query($conexion, "SELECT equipo.idequipo, area.area, equipo.descripcion, equipo.cantidad, equipo.marca, equipo.modelo, equipo.numeroserie, equipo.numeroserie, equipo.observaciones, equipo.foto
                    FROM equipo
                    INNER JOIN area ON equipo.area = area.idarea");
                ...
                $datos = mysqli_fetch_all($query, MYSQLI_ASSOC);
                                    ...
                                    <td><div id="div"><?php echo nl2br($datos['area'])  ?></div></td>
                                    <td><div id="div"><img class="img_producto" src="<?php echo $foto; ?>" alt="<?php echo $datos["descripcion"];?>"></div></td>
                                                    <td> 
                                                        
                                                        <button class = "link_edit" > <a  href="editar_equipo.php? id= <?php echo $datos["idequipo"];?>"><i class="fa fa-pencil-square-o" style="color: white;"></i> </a></button> 

                                                        

                                                        <button class="link_delete delete_product" ><a href="eliminar_equipo.php? id= <?php echo $datos["idequipo"];?>" product="<?php echo $datos["idequipo"];?>" class="delete"> <i class="fa fa-trash-o" style="color: white;"></i>  </a></button>
